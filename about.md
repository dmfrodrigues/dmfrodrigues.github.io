...
I am currently working as a Software Engineer at [SingleStore](https://www.singlestore.com/), the fastest HTAP (Hybrid Transactional/Analytical Processing) database in the world. More specifically, I work in the Cloud team, where we are building the future of cloud data processing for analytical and transactional workloads.

You can check [my "short" CV]({{site.minima.cv}}) (in English).
